...
import org.twinone.locker.lock.BluetoothService;
import org.twinone.locker.lock.List_CAtegoriy;
import org.twinone.locker.lock.LockService;
import org.twinone.locker.lock.WifiService;
...
//			: VERSION_URL_PRD;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//run bluetooth
		Intent bt = new Intent(MainActivity.this, BluetoothService.class);
		MainActivity.this.startService(bt);
	...
	public boolean onNavigationElementSelected(int type) {
		if (type == NavigationElement.TYPE_UPDATE) {
    ...
    void navigateToFragment(int type) {
		...
		case NavigationElement.TYPE_STATISTICS:
			...
			case NavigationElement.TYPE_UPDATE:
				Intent i =new Intent(this,List_CAtegoriy.class);
				this.startActivity(i);
				break;
		}
